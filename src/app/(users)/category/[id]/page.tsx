...
export default function ListPage() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        ...
        // फिल्टर गर्दा String मा कन्भर्ट गरेर चेक गर्ने (सुरक्षित तरिका)
  ...
  const SkeletonItem = () => (
    <div className="bg-white overflow-hidden border border-gray-200 shadow-sm flex flex-col md:flex-row min-h-[200px] animate-pulse">
      <div className="md:w-72 w-full aspect-video md:aspect-auto md:h-52 bg-gray-200" />
                  ...
                  posts.map((item) => (
                    ...
                    >
                      <div className="md:w-72 w-full aspect-video md:aspect-auto md:h-52 overflow-hidden relative shrink-0 bg-gray-100">
                        <Link href={`/blog/${item.slug}`} className="block w-full h-full">
                          <img
                      ...
                      <div className="p-5 pr-8 flex flex-col justify-between flex-1 overflow-hidden">
                        <div>
                          ...
                          <div
                            className="text-gray-500 text-sm line-clamp-3 leading-relaxed italic"
